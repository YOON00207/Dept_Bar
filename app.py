...
if not st.session_state.selected.empty:
    ...
    if st.toggle("데이터 출처 보기"):
        ...
        | 재학생 충원율(%) | 대학알리미 4-라 (학생 충원 현황) | 정원내 재학생 충원율(%){D/(A-B)}×100 | 계열별 자료 사용 | 2024년도 파일에는 2023하반기 2024 상반기 / 2023년도 파일에는 2023상반기 2022하반기 존재하여 2023년 상,하반기 각각 추출해서 평균
 /n/n A=학생정원, B=모집정지인원, D=재학생 정원내 |
