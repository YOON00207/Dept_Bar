...
# =============================================================
    ...
    if st.toggle("데이터 출처 보기"):
        ...
        | 교원 1인당 연구(논문) 실적(건) - 연구재단등재지 | [대학알리미] 공시 데이터 다운로드 → 7-가. 전임교원의 연구 실적| 전임교원 1인당 연구재단등재지(후보포함) | 좌측 열 그대로 반영 |  |
        | 교원 1인당 연구(논문) 실적(건) - SCI급/SCOPUS |[대학알리미] 공시 데이터 다운로드 → 7-가. 전임교원의 연구 실적| 전임교원 1인당 SCI급/SCOPUS학술지 | 좌측 열 그대로 반영 |  |
